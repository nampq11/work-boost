...
export interface LongTermMemory {
  ...
  store(memory: Omit<MemoryEntry, 'id' | 'createdAt' | 'lastAccessedAt' | 'accessCount'>): Promise<string>;

  /** Retrieve memories relevant to a query */
  retrieve(query: string, userId: string, options?: MemoryRetrieveOptions): Promise<MemorySearchResult[]>;
  ...
  getByUser(userId: string, options?: { type?: MemoryType; limit?: number }): Promise<MemoryEntry[]>;
