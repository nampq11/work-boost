 ...
 * - ['debts_by_user', userId, debtId] -> Debt (user's debts)
 * - ['unpaid_debts_by_user', userId, debtId] -> Debt (only pending debts)
 * - ['debt_reminders', userId] -> DebtReminderSettings
 *
 * Migration Keys:
...
export const IndexKeys = {
  ...
  // Debt indexes
  debtsByUserPrefix: (userId: string) => ['debts_by_user', userId] as const,
  debtByUser: (userId: string, debtId: string) => ['debts_by_user', userId, debtId] as const,
  unpaidDebtsByUserPrefix: (userId: string) => ['unpaid_debts_by_user', userId] as const,
  unpaidDebtByUser: (userId: string, debtId: string) =>
