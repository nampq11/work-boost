...
function TreeNode({
  ...
  // Using a derived boolean selector prevents all tree nodes from re-rendering
  // when activePath changes, as only the newly active and previously active nodes will update.
