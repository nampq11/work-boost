...
export const en = {
  ...
  'update.waitingPermission': 'Waiting for your permission to install the update...',
  'update.permissionHint':
    'Work Boost needs your permission to install. Check for a password prompt from your system.',
  'update.downloading': 'Downloading the update...',
  'update.installing': 'Installing the update...',
  'update.restarting': 'Installed. Restarting Work Boost...',
  'update.willRestart': 'Work Boost will stay open and restart automatically.',
  'update.doNotQuit': "Don't force quit while the update is installing.",
  'update.failed': 'Update failed: {{message}}',
  'update.manual': 'Manual install required: {{message}}',
  'update.retry': 'Retry',
  'update.manualInstall': 'Get manual installer',
  ...
  'copilot.auth.provider': 'AI provider',
  ...
  'copilot.auth.connectApiKey': 'Connect with API key',
  'copilot.auth.connectApiKeyWith': 'Connect {{name}} with an API key',
  'copilot.auth.apiKeyPlaceholder': 'Paste your API key',
  'copilot.auth.apiKeyRequired': 'Enter an API key first.',
  'copilot.auth.useApiKeyInstead': 'Use an API key instead',
  'copilot.auth.useOAuthInstead': 'Use browser sign-in instead',
  'copilot.auth.model': 'Model',
  'copilot.auth.modelPlaceholder': 'e.g. anthropic/claude-sonnet-4.5',
  'copilot.auth.modelHint': 'OpenRouter requires a model id to connect.',
  'copilot.auth.noSupportedMethods': 'This provider has no supported sign-in method.',
  ...
  'copilot.auth.pasteCodePlaceholder': 'Paste the authorization code or redirect URL',
  'copilot.auth.submitCode': 'Submit code',
  'copilot.auth.unableSubmitCode': 'Failed to submit the code.',
  'copilot.auth.unableSaveApiKey': 'Failed to save the API key.',
