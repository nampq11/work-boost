...
export const ERROR_CODES = {
  ...
  AI_CONFIG_INVALID_PROVIDER: 'AI_CONFIG_INVALID_PROVIDER',
  AI_CONFIG_MODEL_REQUIRED: 'AI_CONFIG_MODEL_REQUIRED',
  AI_CONFIG_UNKNOWN_MODEL: 'AI_CONFIG_UNKNOWN_MODEL',
  INTERNAL_ERROR: 'INTERNAL_ERROR',
  VALIDATION_ERROR: 'VALIDATION_ERROR',
  CONFLICT: 'CONFLICT',
  AUTH_LOGIN_IN_PROGRESS: 'AUTH_LOGIN_IN_PROGRESS',
  AUTH_LOGIN_NOT_FOUND: 'AUTH_LOGIN_NOT_FOUND',
  AUTH_LOGIN_EXPIRED: 'AUTH_LOGIN_EXPIRED',
  AUTH_LOGIN_CANCELLED: 'AUTH_LOGIN_CANCELLED',
  AUTH_PROVIDER_NOT_ACTIVE: 'AUTH_PROVIDER_NOT_ACTIVE',
  AUTH_OAUTH_UNSUPPORTED: 'AUTH_OAUTH_UNSUPPORTED',
  AUTH_SERVICE_UNAVAILABLE: 'AUTH_SERVICE_UNAVAILABLE',
  AUTH_REFRESH_FAILED: 'AUTH_REFRESH_FAILED',
  AUTH_ALREADY_CONNECTED: 'AUTH_ALREADY_CONNECTED',
  ASSISTANT_SERVICE_UNAVAILABLE: 'ASSISTANT_SERVICE_UNAVAILABLE',
} as const;
